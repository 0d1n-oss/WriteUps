...
2. Acceder desde el navegador a `http://localhost:8899` (u otra IP/puerto).
...
![Reto 1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/1.png)
...
![Reto 1-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/1-2.png)

---

### Reto 2 — Broken Authentication

![Reto 2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/2.png)

La cookie de sesión contiene información del usuario y no está protegida ni validada correctamente del lado del servidor.

![Reto 2-3](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/2-3.png)

Tras obtener una cookie válida (`user1`), se puede clonar y modificar para crear otra (`user2`).

![Reto 2-4](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/2-4.png)

Usando Burp Suite se intercepta la petición y se reemplaza la cookie para acceder a los recursos de otro usuario.

![Reto 2-5](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/2-5.png)
...
![Reto 3](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/3.png)

#### Reflected

![Reto 3-1-1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/3-1-1.png)

```html
<script>window.location.href="/unlucky.php";</script>
```

![Reto 3-1-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/3-1-2.png)

#### Stored

![Reto 3-2-1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/3-2-1.png)

```html
<script>window.location.href="/hacked_users.php";</script>
```

![Reto 3-2-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/3-2-2.png)

---

### Reto 4 — Insecure Direct Object References (IDOR)

![Reto 4](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/4.png)

El sistema redirige a archivos PDF cuyos nombres están codificados en hexadecimal.

![Reto 4-1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/4-1.png)
...
![Reto 4-4](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/4-4.png)

---

### Reto 5 — File Inclusion / Source Disclosure

![Reto 5](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/5.png)
...
![Reto 5-1-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/5-1-2.png)
![Reto 5-1-1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/5-1-1.png)

---

### Reto 6 — Lógica insegura

![Reto 6](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/6.png)

La aplicación valida los descuentos del lado del cliente, permitiendo descubrir un código especial analizando el HTML/JS.

![Reto 6-1](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/6-1.png)
...
![Reto 8](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/8.png)

La aplicación no implementa tokens CSRF.

![Reto 8-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/8-2.png)

```html
<img src="http://172.17.0.3/update_email.php?new_email=user1@evil.com&user=user1&Update=Save">
```

![Reto 8-6](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/8-6.png)
![Reto 8-7](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/8-7.png)
...
![Reto 9](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/9.png)
![Reto 9-2](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/9-2.png)

```
fm.php?u=humphrey
```

![Reto 9-3](https://github.com/0d1n-oss/WriteUps/blob/main/Security%20Ninjas/images/9-3.png)
